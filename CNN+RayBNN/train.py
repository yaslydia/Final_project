...
f_set = '/home/cxyycl/scratch/Microsleep-code/code/CNN_16s/set2/file_sets.mat'
...
for i in range(n_ep):
	...
	model.save('/home/cxyycl/scratch/Microsleep-code/code/models/model_ep'+str(i)+'.h5')
...
model.save('/home/cxyycl/scratch/Microsleep-code/code/models/model.h5')
